...
- Deel de Plus altijd op in meerdere delen, zodat elk afgerond deel al een
  ...
  - **Losstaande oefeningen** (elk deel is een eigen scenario met een eigen
    ...
    delen. Zie `014-interactive-rebase-typefout-repareren.md` en
    `023-submodule.md` als voorbeeld.
...
- Oefeningen 007, 010, 011, 012 en 013 afmaken in dezelfde stijl als de
  bestaande oefeningen (per onderwerp uit de root-README: mergen, reset,
  force push, amend+force push, regeleindes - rebase, revert en
  reflog/tijdreizen
